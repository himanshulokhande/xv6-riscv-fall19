...
void print(void *buf) { printf("%d: received %s \n", getpid(), buf); }
  ...
  10:	3be080e7          	jalr	958(ra) # 3ca <getpid>
  14:	85aa                	mv	a1,a0
  16:	8626                	mv	a2,s1
  18:	00001517          	auipc	a0,0x1
  1c:	85850513          	addi	a0,a0,-1960 # 870 <malloc+0xe8>
  20:	00000097          	auipc	ra,0x0
  24:	6aa080e7          	jalr	1706(ra) # 6ca <printf>
  28:	60e2                	ld	ra,24(sp)
  2a:	6442                	ld	s0,16(sp)
  2c:	64a2                	ld	s1,8(sp)
...
int main(int argc, char *argv[]) {
  ...
  34:	ec86                	sd	ra,88(sp)
  36:	e8a2                	sd	s0,80(sp)
  38:	1080                	addi	s0,sp,96
    pipe(parent_fd);
  3a:	fe840513          	addi	a0,s0,-24
  3e:	00000097          	auipc	ra,0x0
  42:	31c080e7          	jalr	796(ra) # 35a <pipe>
    pipe(child_fd);
  46:	fe040513          	addi	a0,s0,-32
  4a:	00000097          	auipc	ra,0x0
  4e:	310080e7          	jalr	784(ra) # 35a <pipe>
    if (fork()) {
  52:	00000097          	auipc	ra,0x0
  56:	2f0080e7          	jalr	752(ra) # 342 <fork>
  5a:	c129                	beqz	a0,9c <main+0x6a>
        write(parent_fd[1], "ping", 4);
  5c:	4611                	li	a2,4
  5e:	00001597          	auipc	a1,0x1
  62:	82a58593          	addi	a1,a1,-2006 # 888 <malloc+0x100>
  66:	fec42503          	lw	a0,-20(s0)
  6a:	00000097          	auipc	ra,0x0
  6e:	300080e7          	jalr	768(ra) # 36a <write>
        read(child_fd[0], buf, sizeof(buf));
  72:	04000613          	li	a2,64
  76:	fa040593          	addi	a1,s0,-96
  7a:	fe042503          	lw	a0,-32(s0)
  7e:	00000097          	auipc	ra,0x0
  82:	2e4080e7          	jalr	740(ra) # 362 <read>
        print(buf);
  86:	fa040513          	addi	a0,s0,-96
  8a:	00000097          	auipc	ra,0x0
  8e:	f76080e7          	jalr	-138(ra) # 0 <print>
    exit(0);
  92:	4501                	li	a0,0
  94:	00000097          	auipc	ra,0x0
  98:	2b6080e7          	jalr	694(ra) # 34a <exit>
        read(parent_fd[0], buf, sizeof(buf));
  9c:	04000613          	li	a2,64
  a0:	fa040593          	addi	a1,s0,-96
  a4:	fe842503          	lw	a0,-24(s0)
  a8:	00000097          	auipc	ra,0x0
  ac:	2ba080e7          	jalr	698(ra) # 362 <read>
        print(buf);
  b0:	fa040513          	addi	a0,s0,-96
  b4:	00000097          	auipc	ra,0x0
  b8:	f4c080e7          	jalr	-180(ra) # 0 <print>
        write(child_fd[1], "pong", 4);
  bc:	4611                	li	a2,4
  be:	00000597          	auipc	a1,0x0
  c2:	7d258593          	addi	a1,a1,2002 # 890 <malloc+0x108>
  c6:	fe442503          	lw	a0,-28(s0)
  ca:	00000097          	auipc	ra,0x0
  ce:	2a0080e7          	jalr	672(ra) # 36a <write>
  d2:	b7c1                	j	92 <main+0x60>
...
putc(int fd, char c)
{
 ...
 408:	f66080e7          	jalr	-154(ra) # 36a <write>
}
...
free(void *ap)
{
 ...
 70e:	1ae7b783          	ld	a5,430(a5) # 8b8 <freep>
...
malloc(uint nbytes)
{
 ...
 7b0:	10c53503          	ld	a0,268(a0) # 8b8 <freep>
 ...
 7d8:	0e490913          	addi	s2,s2,228 # 8b8 <freep>
  if(p == (char*)-1)
 7dc:	5afd                	li	s5,-1
 7de:	a88d                	j	850 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7e0:	00000797          	auipc	a5,0x0
 7e4:	0e078793          	addi	a5,a5,224 # 8c0 <base>
 7e8:	00000717          	auipc	a4,0x0
 7ec:	0cf73823          	sd	a5,208(a4) # 8b8 <freep>
 7f0:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 812:	0aa73523          	sd	a0,170(a4) # 8b8 <freep>
      return (void*)(p + 1);
 ...
 860:	b76080e7          	jalr	-1162(ra) # 3d2 <sbrk>
  if(p == (char*)-1)
