...
free(void *ap)
{
 ...
 680:	1a47b783          	ld	a5,420(a5) # 820 <freep>
 ...
 6ae:	00e6ea63          	bltu	a3,a4,6c2 <free+0x50>
{
 ...
 6f0:	12f73a23          	sd	a5,308(a4) # 820 <freep>
}
 6f4:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 722:	10253503          	ld	a0,258(a0) # 820 <freep>
 ...
 74a:	0da90913          	addi	s2,s2,218 # 820 <freep>
  if(p == (char*)-1)
 74e:	5afd                	li	s5,-1
 750:	a88d                	j	7c2 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 752:	00000797          	auipc	a5,0x0
 756:	0d678793          	addi	a5,a5,214 # 828 <base>
 75a:	00000717          	auipc	a4,0x0
 75e:	0cf73323          	sd	a5,198(a4) # 820 <freep>
 762:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 784:	0aa73023          	sd	a0,160(a4) # 820 <freep>
      return (void*)(p + 1);
